...
//-----------------------------------------------------------------------------
std::uint32_t __fastcall RTech::DecompressedSize(int64_t param_buf, std::uint8_t* file_buf, std::int64_t file_size, std::int64_t off_no_header, std::int64_t header_size)
{
    std::int64_t       v8;    // r9
    std::uint64_t      v9;    // r11
    char              v10;    // r8
